            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="card card-info shadow-sm">
                        ...
                        <form action="{{ route('update_banner', $edit->id) }}" method="POST" enctype="multipart/form-data" class="p-3">
                            @csrf

                            <div class="form-group mb-3">
                                <label class="form-label">Tiêu đề <span class="text-danger">*</span></label>
                                <input type="text" name="content" value="{{ $edit->content }}" class="form-control" required>
                            </div>

                            <div class="form-group mb-3">
                                <label class="form-label">Đường dẫn</label>
                                <input type="text" name="link" value="{{ $edit->link }}" class="form-control" required>
                            </div>

                            @if($edit->image)
                            <div class="mb-2">
                                <img src="{{ asset($edit->image) }}" alt="Current image" style="max-width: 200px; max-height: 200px; border: 1px solid #ddd; padding: 5px; border-radius: 4px;">
