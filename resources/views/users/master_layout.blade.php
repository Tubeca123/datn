			...
			<div class="mn-sidebar-body">
				...
				<ul class="mn-sb-list">
					@php
						...
						$parents = $main_category->where('parent_id', 0);
					@endphp
					...
					@foreach($parents as $parent)
						...
						@php
							// Danh mục con (cấp 1)
							$children = $main_category->where('parent_id', $parent->id);
						@endphp
						...
						@foreach($children as $child)
							...
							@php
								// Danh mục cháu (cấp 2)
								$subChildren = $main_category->where('parent_id', $child->id);
							@endphp
							...
							@if($subChildren->isEmpty())
								<li class="mn-sb-item sb-drop-item">
									<a href="shop-right-sidebar.html" class="mn-drop-toggle">
										...
										<img src="{{ $child->image ? asset( $child->image) : 'https://png.pngtree.com/png-clipart/20210912/original/pngtree-pills-medicine-capsules-png-image_6722284.jpg' }}" alt="">
										<span class="condense">{{ $child->name }}</span>
									</a>
								</li>
								...
								<li class="mn-sb-item sb-drop-item">
									...
									<ul class="mn-sb-drop">
										@foreach($subChildren as $sub)
											<li class="list">
												<a href="shop-right-sidebar.html" class="mn-page-link drop">
													{{ $sub->name }}
												</a>
											</li>
										@endforeach
											...
											<ul>
												...
												<li class="dropdown drop-list">
													...
													<ul class="mega-menu d-block">
														<li class="d-flex">
															<span class="bg"></span>
															@foreach($main_category->where('parent_id', 0)->take(5) as $parent)
																<ul class="d-block mega-block">
																	<li class="menu_title"><a
																			href="{{route('shop')}}">{{$parent->name}}</a></li>
																	@foreach($main_category->where('parent_id', $parent->id)->take(3) as $child)
																		<li><a href="{{route('shop', ['category' => [$child->id]] )}}">{{$child->name}}</a></li>
																	@endforeach
												...
												<li class="dropdown drop-list">
													<a href="javascript:void(0)" class="dropdown-arrow">Trang khác<i
															class="ri-arrow-down-s-line"></i></a>
													<ul class="sub-menu">
														<li class="dropdown position-static">
															<a href="{{route('blog')}}" class="mn-sub-drop">Bài viết
										...
										<div class="header-top-social">
											<ul class="mb-0">
												<li class="list-inline-item">
													<a href="index.html#"><i class="ri-facebook-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="index.html#"><i class="ri-twitter-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="index.html#"><i class="ri-instagram-line"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="index.html#"><i class="ri-linkedin-fill"></i></a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="mn-tool-user">
								...
								<ul class="sub-menu" style='width:250px'>
									@if(Auth::check())
										...
										<li>
											<a href="{{ route('user_logout') }}">Đăng xuất</a>
										</li>
									@else
										<li>
											<a href="{{route('user_login')}}">Đăng nhập</a>
										</li>
										<li>
											<a href="{{route('user_register')}}">Đăng ký</a>
										</li>
									@endif
								</ul>
							</div>
