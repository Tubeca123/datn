										...
										<div class="header-top-social">
											<ul class="mb-0">
												<li class="list-inline-item">
													<a href="cart.html#"><i class="ri-facebook-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="cart.html#"><i class="ri-twitter-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="cart.html#"><i class="ri-instagram-line"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="cart.html#"><i class="ri-linkedin-fill"></i></a>
												</li>
											</ul>
										</div>
									</div>
												...
												<tbody>
													<tr class="mn-cart-product">
														...
														<td data-label="Remove" class="mn-cart-pro-remove">
															<a href="cart.html#"><i class="ri-delete-bin-line"></i></a>
														</td>
													</tr>
													<tr class="mn-cart-product">
														<td data-label="Product" class="mn-cart-pro-name">
