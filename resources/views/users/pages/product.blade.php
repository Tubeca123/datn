										...
										<div class="header-top-social">
											<ul class="mb-0">
												<li class="list-inline-item">
													<a href="product-accordion-full-width.html#"><i class="ri-facebook-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="product-accordion-full-width.html#"><i class="ri-twitter-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="product-accordion-full-width.html#"><i class="ri-instagram-line"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="product-accordion-full-width.html#"><i class="ri-linkedin-fill"></i></a>
												</li>
											</ul>
										</div>
									</div>
					...
					<section class="mn-single-product">
						<div class="row">
							<div class="mn-pro-rightside mn-common-rightside col-lg-12 col-md-12 m-b-15">
												...
												<div class="single-pro-content">
													...
													<div class="mn-single-rating-wrap">
														...
														<span class="mn-read-review">
															|&nbsp;&nbsp;<a href="product-accordion-full-width.html#mn-spt-nav-review">992 Ratings</a>
														</span>
													</div>
								...
								<div class="mn-accordion style-1 mn-single-pro-tab-content">
									...
									<div class="mn-accordion-item">
										...
										<div class="mn-accordion-body pb-0">
											<div id="mn-spt-nav-review" class="a-tab-pane">
												<div class="row">
													<div class="mn-t-review-wrapper">
													...
													<div class="mn-ratting-content">
														...
														<div class="mn-ratting-form">
															<form action="product-accordion-full-width.html#">
									...
									<div class="mn-related owl-carousel">
										<div class="mn-product-card">
											...
											<div class="mn-product-detail">
												...
												<h5><a href="product-accordion-full-width.html">Cotton fabric T-shirt</a></h5>
												<div class="mn-price">
												...
												<div class="mn-pro-option">
													<div class="mn-pro-color">
														<ul class="mn-opt-swatch mn-change-img">
															<li class="active"><a href="product-accordion-full-width.html#" class="mn-opt-clr-img active"
															...
															<li><a href="product-accordion-full-width.html#" class="mn-opt-clr-img"
										...
										<div class="mn-product-card">
											...
											<div class="mn-product-detail">
												...
												<h5><a href="product-accordion-full-width.html">Special sport shoes</a></h5>
												<div class="mn-price">
										...
										<div class="mn-product-card">
											...
											<div class="mn-product-detail">
												...
												<h5><a href="product-accordion-full-width.html">Cotton fabric Top</a></h5>
												<div class="mn-price">
													<div class="mn-price-new">$120</div>
													<div class="mn-price-old">$130</div>
												</div>
										...
										<div class="mn-product-card">
											...
											<div class="mn-product-detail">
												...
												<h5><a href="product-accordion-full-width.html">Mantu smart watch</a></h5>
												<div class="mn-price">
										...
										<div class="mn-product-card">
											...
											<div class="mn-product-detail">
												...
												<h5><a href="product-accordion-full-width.html">Mantu leather belt</a></h5>
												<div class="mn-price">
										...
										<div class="mn-product-card">
											...
											<div class="mn-product-detail">
												...
												<h5><a href="product-accordion-full-width.html">Leather bag</a></h5>
												<div class="mn-price">
