	...
	<div class="row">
		<div class="col-xxl-12">
				...
				<div class="mn-product owl-carousel">
					...
					<div class="mn-product-card">
						...
						<div class="mn-product-detail">
							<h5><a href="{{route('product',['product_id'=> $product->id])}}">{{$product->name}}</a></h5>
							<div class="mn-price">
								@if ($unit)
			...
			<section class="mn-blog p-tb-15">
				<div class="mn-title">
					<h2>Bài <span>Viết</span></h2>
				</div>
				<div class="mn-blog-carousel owl-carousel">
					@foreach ($news as $new)
					<div class="mn-blog-card">
						<div class="blog-info">
							<figure class="blog-img"><a href="{{ route('blogdetail', ['id' => $new->id]) }}"><img src="{{asset($new->image)}}"
										alt="news imag"></a>
							</figure>
							<div class="detail">
								<label>{{ $new->create_date}}</label>
								<label><a href="index.html#">{{$new->category->name}}</a></label>
								<h3><a href="{{ route('blogdetail', ['id' => $new->id]) }}">{{$new->title}}</a></h3>
								<div class="more-info">
									<a href="{{ route('blogdetail', ['id' => $new->id]) }}">Read More<i
