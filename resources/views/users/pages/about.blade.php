...
@section('main-content')
    <main class="wrapper sb-default">
										...
										<div class="header-top-social">
											<ul class="mb-0">
												<li class="list-inline-item">
													<a href="about-us.html#"><i class="ri-facebook-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="about-us.html#"><i class="ri-twitter-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="about-us.html#"><i class="ri-instagram-line"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="about-us.html#"><i class="ri-linkedin-fill"></i></a>
												</li>
											</ul>
										</div>
									</div>
		...
		<div class="mn-main-content">
			...
			<!-- Facts Section -->
			<section class="mn-facts-section p-tb-15">
				<div class="row m-b-m-24">
					<div class="mn-facts-content col-sm-6 col-xl-3 m-b-24">
						<div class="mn-facts-inner">
							<div class="mn-count">
								<span class="counter">65K+</span>
							</div>
							<div class="mn-facts-desc">
								<h4>Vendors</h4>
							...
							<div class="mn-team-socials">
								<ul class="align-itemn-center">
									<li class="mn-social-link">
										<a href="about-us.html#"><i class="ri-twitter-line"></i></a>
									</li>
									<li class="mn-social-link">
										<a href="about-us.html#"><i class="ri-facebook-line"></i></a>
									</li>
									<li class="mn-social-link">
										<a href="about-us.html#"><i class="ri-linkedin-line"></i></a>
									</li>
								</ul>
							</div>
						</div>
