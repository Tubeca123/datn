										...
										<div class="header-top-social">
											<ul class="mb-0">
												<li class="list-inline-item">
													<a href="checkout.html#"><i class="ri-facebook-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="checkout.html#"><i class="ri-twitter-fill"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="checkout.html#"><i class="ri-instagram-line"></i></a>
												</li>
												<li class="list-inline-item">
													<a href="checkout.html#"><i class="ri-linkedin-fill"></i></a>
												</li>
											</ul>
										</div>
									</div>
						...
						<div class="mn-checkout-content">
							<div class="mn-checkout-inner">
								<div class="mn-checkout-wrap m-b-30">
									<div class="mn-checkout-block mn-check-new">
										...
										<div class="mn-check-block-content">
											...
											<div class="mn-new-btn"><a href="checkout.html#"
										...
										<div class="mn-check-login-form">
											<form action="checkout.html#" method="post">
												...
												<span class="mn-check-login-wrap mn-check-login-btn">
													...
													<a class="mn-check-login-fp" href="checkout.html#">Forgot Password?</a>
												</span>
											</form>
										</div>
									</div>
								...
								<span class="mn-check-order-btn m-t-30">
									<a class="mn-btn-2" href="checkout.html#"><span>Place Order</span></a>
								</span>
							</div>
						</div>
						<!--cart content End -->
									...
									<div class="mn-checkout-summary">
										...
										<div class="mn-checkout-coupan-content">
											<form class="mn-checkout-coupan-form" name="mn-checkout-coupan-form"
												method="post" action="checkout.html#">
									...
									<div class="mn-checkout-pay">
										...
										<form action="checkout.html#">
											...
											<span class="mn-pay-agree">
												...
												I have agree with <a href="checkout.html#">Terms & Conditions.</a>
